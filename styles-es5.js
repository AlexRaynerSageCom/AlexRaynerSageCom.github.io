(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["styles"], {
  ...
  function node_modulesCssLoaderDistCjsJsNode_modulesPostcssLoaderSrcIndexJsNode_modulesSassLoaderDistCjsJsSrcStylesScss(module, exports, __webpack_require__) {
    ...
    exports.push([module.i, "/* You can add global styles to this file, and also import other style files */\nhtml, body {\n  margin: 0;\n  font-family: \"Roboto\", sans-serif;\n  font-size: 14px;\n}\ninput:focus, button:focus {\n  outline: 3px solid #ffb500;\n}\ninput {\n  padding: 0px 11px;\n  line-height: 2.5em;\n  background-color: #fff;\n  border: 1px solid #668592;\n  box-sizing: border-box;\n  width: 100%;\n}\nbutton {\n  cursor: pointer;\n  border-radius: 0;\n  display: inline-block;\n  padding: 0px 11px;\n  margin: 8px;\n  line-height: 2.5em;\n  border: 2px solid transparent;\n  background-color: #008200;\n  color: #fff;\n  font-weight: bold;\n}\nbutton:hover {\n  background-color: #006300;\n}\nbutton[disabled] {\n  cursor: not-allowed;\n  background-color: #e6ebed;\n  color: rgba(0, 0, 0, 0.3);\n}", "", {
      "version": 3,
      "sources": ["C:\\Users\\alex.rayner\\Development\\layout-builder/src\\styles.scss", "styles.scss"],
      "names": [],
      "mappings": "AAAA,8EAAA;AACA;EACE,SAAA;EACA,iCAAA;EACA,eAAA;ACCF;ADGE;EACE,0BAAA;ACAJ;ADIA;EACE,iBAAA;EACA,kBAAA;EACA,sBAAA;EACA,yBAAA;EACA,sBAAA;EACA,WAAA;ACDF;ADIA;EACE,eAAA;EACA,gBAAA;EACA,qBAAA;EACA,iBAAA;EACA,WAAA;EACA,kBAAA;EACA,6BAAA;EACA,yBAAA;EACA,WAAA;EACA,iBAAA;ACDF;ADGE;EACE,yBAAA;ACDJ;ADIE;EACE,mBAAA;EACA,yBAAA;EACA,yBAAA;ACFJ",
      "file": "styles.scss",
